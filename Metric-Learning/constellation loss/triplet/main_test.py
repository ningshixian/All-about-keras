...
if __name__ == '__main__':
    ...
    for k in k_number:
        ...
        for seed in random_seeds:
            ...
            if keras.backend.backend() == 'tensorflow':
                ...
                with K.tf.device(gpu_device):
                    ...
                    model.load_weights('final_exp/' + str(k) + '/weights/inception_triplet_fold_' + str(fold) + '.h5')
        ...
        df.to_csv('final_exp/results_knn/final_exp_k_' + str(k) + '.csv')
